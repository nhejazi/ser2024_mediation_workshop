...
My research interests blend causal inference, machine learning, non- and
semi-parametric inference, and computational statistics, with areas of recent
emphasis having included causal mediation analysis, estimation under
outcome-dependent sampling, causal inference with continuous-valued or ordinal
treatments, and sieve methods for machine learning-based estimation in causal
inference. My methodological work is motivated by scientific problems arising
in clinical trials and observational studies of infectious diseases and
infectious disease epidemiology. I am also passionate about statistical
computing and programming, and the design of open source software tools for
reproducible statistical data science.
...
more about hte details of how the `renv` virtual environment system works, the
