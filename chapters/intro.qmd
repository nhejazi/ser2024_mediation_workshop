# What is causal mediation analysis? {#mediation}
...
The above graphs can be interpreted as a *non-parametric structural equation
model* (NPSEM), also known as *structural causal model* (SCM):
...
- In the NPSEM framework, counterfactuals are quantities *derived* from the
  model.
